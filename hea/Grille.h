...
protected:
    ...
    std::unordered_map<std::pair<int, int>, std::shared_ptr<AbstractCellule>, Hash> Cellules;      // Grille stockée sous forme de tableau 1D
public:
    AbstractGrille();
    AbstractGrille(int X, int Y);
    AbstractGrille(int X, int Y, std::unordered_map<std::pair<int, int>, std::shared_ptr<AbstractCellule>, Hash> cellules);
...
public:
    ...
    GrilleClassique(int X, int Y, std::unordered_map<std::pair<int, int>, std::shared_ptr<AbstractCellule>, Hash> cellules);
    ~GrilleClassique();
...
public:
    ...
    GrilleTorique(int X, int Y, std::unordered_map<std::pair<int, int>, std::shared_ptr<AbstractCellule>, Hash> cellules);
    ~GrilleTorique();
